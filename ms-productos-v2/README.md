...
## Descripción
MS Productos V2 es un microservicio reactivo desarrollado con Spring WebFlux que proporciona gestión completa de productos con las siguientes características:
...
**Tecnologías**: Spring Boot 3, Spring WebFlux, R2DBC, PostgreSQL, Kafka, Eureka, Gradle
**Puerto**: 8083
**Estado**: ✅ Activo y funcionando correctamente
**Eventos**: ✅ Publicando a Kafka
**Database**: ✅ PostgreSQL con R2DBC
